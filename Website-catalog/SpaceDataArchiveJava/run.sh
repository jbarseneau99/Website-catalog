#!/bin/bash
# Space Data Archive System Runner Script
...
PROJECT_DIR="/Users/jbarseneau/Desktop/Website-catalog/SpaceDataArchiveJava"
cd "$PROJECT_DIR"
...
MODULE_PATH="$PROJECT_DIR/target/deps"
...
$JAVA_CMD \
  ...
  -Dprism.order=sw \
  -cp "$PROJECT_DIR/target/classes:$MODULE_PATH/*" \
